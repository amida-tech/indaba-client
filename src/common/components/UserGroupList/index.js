            ...
            <div className='user-group-list'>
                {
                    ...
                    <div className='user-group-list__header'>
                        <div className='user-group-list__header-section__user-group-list__header-section--name'>
                            {this.props.vocab.PROJECT.GROUP_NAME}
                        </div>
                        <div className='user-group-list__header-section__user-group-list__header-section--members'>
                            {this.props.vocab.PROJECT.GROUP_MEMBERS}
                        </div>
                        <div className='user-group-list__header-section__user-group-list__header-section--action'>
