export default {
    ...
    INDABA_CLIENT_URL: window.INDABA_CLIENT_URL || process.env.INDABA_CLIENT_URL || 'http://localhost:3000',
    ...
    INDABA_CLIENT_DEFAULT_REALM: window.INDABA_CLIENT_DEFAULT_REALM || process.env.INDABA_CLIENT_DEFAULT_REALM || 'develop',
