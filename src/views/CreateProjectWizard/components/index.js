        ...
        return (!this.props.ui.showComplete ?
            <div className='project-wizard'>
                ...
                <Tabs className='project-wizard__tabs'
                    ...
                    <Tab className={`project-wizard__tab project-wizard__tab--${this.props.ui.step > 0 ? 'complete' : 'incomplete'}`}
                        title={this.props.vocab.PROJECT.CREATE_SURVEY}>
                        <SurveyEditorStep />
                    </Tab>
                    <Tab className={`project-wizard__tab project-wizard__tab--${this.props.ui.step > 1 ? 'complete' : 'incomplete'}`}
                    ...
                    <Tab className={`project-wizard__tab project-wizard__tab--${this.props.ui.step > 2 ? 'complete' : 'incomplete'}`}
                    ...
                    <Tab className={`project-wizard__tab project-wizard__tab--${this.props.ui.step > 3 ? 'complete' : 'incomplete'}`}
